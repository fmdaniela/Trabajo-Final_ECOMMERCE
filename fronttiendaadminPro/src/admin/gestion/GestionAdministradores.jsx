...
//               type="text"
//               placeholder="Buscar administrador..."
//               className="w-full py-2 pl-10 pr-4 border rounded-lg dark:bg-gray-700 dark:text-white border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-violet-500"
//               value={searchTerm}
//               onChange={(e) => setSearchTerm(e.target.value)}
//             />
...
//           <div className="relative">
//             <select
//               className="w-full py-2 pl-10 pr-4 border rounded-lg appearance-none dark:bg-gray-700 dark:text-white border-gray-300 dark:border-gray-600 focus:outline-none focus:ring-2 focus:ring-violet-500"
//               value={statusFilter}
//               onChange={(e) => setStatusFilter(e.target.value)}
//             >
//               <option value="all">Todos los estados</option>
...
//               <option value="false">Inactivo</option>
//             </select>
//             <Filter className="absolute w-5 h-5 text-gray-400 left-3 top-2.5" />
//           </div>
//           {/* Botón nuevo administrador */}
//           <button
//             onClick={() => handleOpenModal()}
//             className="flex items-center justify-center px-4 py-2 text-white transition-all duration-200 rounded-lg shadow-md bg-gradient-to-r from-violet-400 to-violet-600 hover:from-violet-700 hover:to-violet-800"
//           >
...
//         </div>      
//       {/* ===== Tabla de administradores ===== */}
//         <table className="min-w-full overflow-hidden bg-white rounded-lg dark:bg-gray-800">
