...
function ProductCard({ producto }) {
  const { nombre, imagenUrl, imagen, precio, descuento, destacado, rating } = producto;
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm hover:shadow-lg transition overflow-hidden flex flex-col">
      ...
      <div className="p-4 flex flex-col flex-grow justify-between">
        ...
        <button className="flex items-center justify-center gap-2 bg-gray-100 hover:bg-gray-200 text-[#E91E63] text-sm font-semibold px-4 py-2 rounded cursor-pointer">
