...
const DetalleCategoria = () => {
  ...
  useEffect(() => {
    const fetchCategoria = async () => {
      try {
        // obtenemos el objeto completo con success + data
        const result = await categoriaService.obtenerCategoriaAdminPorId(id);
        setCategoria(result.data || null); // tomamos solo el registro
        setLoading(false);
      } catch (err) {
